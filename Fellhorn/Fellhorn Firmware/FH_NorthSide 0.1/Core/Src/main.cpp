...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(NS_FLASH_CS_4_GPIO_Port, NS_FLASH_CS_4_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : TRIGGER_2_Pin TRIGGER_1_Pin */
  GPIO_InitStruct.Pin = TRIGGER_2_Pin|TRIGGER_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : NS_FLASH_CS_1_Pin */
  GPIO_InitStruct.Pin = NS_FLASH_CS_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(NS_FLASH_CS_1_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : TIME_MARKER_1_Pin TIME_MARKER_2_Pin TIME_MARKER_3_Pin TIME_MARKER_4_Pin */
  GPIO_InitStruct.Pin = TIME_MARKER_1_Pin|TIME_MARKER_2_Pin|TIME_MARKER_3_Pin|TIME_MARKER_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
