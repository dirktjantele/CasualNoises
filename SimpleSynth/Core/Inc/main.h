...
#define FLASH_CS4_Pin GPIO_PIN_3
#define FLASH_CS4_GPIO_Port GPIOG
#define FLASH_CS3_Pin GPIO_PIN_4
#define FLASH_CS3_GPIO_Port GPIOG
#define FLASH_CS2_Pin GPIO_PIN_5
#define FLASH_CS2_GPIO_Port GPIOG
#define FLASH_CS1_Pin GPIO_PIN_6
#define FLASH_CS1_GPIO_Port GPIOG
